        ...
        <div class="row">
          <div class="form-group has-search" >
           <input type="text" class="form-control" placeholder="Search" onkeyup="showData(this.value)">
            ...
            <tr class="info"><th>Date</th> <th> Category</th><th> Money </th><th>Delete</th></tr>
                     ...
                     <?php
                                         ...
                                         if($result->num_rows >0){
                                           while ($row=$result->fetch_assoc()){
                                             ...
                                             echo "<tr><td> " . $exdate. "</td> <td> " . $row["category"]. " </td><td> " . $row["amount"]. "</td> <td> <a href='incomedelete.php?delincome=".$row['id']."' class='btn btn-sm' name='remove' value='remove'><span class='glyphicon glyphicon-remove white' aria-hidden='true'></span></a></td></tr>";
                                             $inctotal+=$row["amount"];
                                           }
                                         ...
                                         if(isset($_GET['delincome']))
                                          {
                                              ...
                                              $removeQuery = "UPDATE income SET isdel='1' Where id=$id AND username='$email'";
