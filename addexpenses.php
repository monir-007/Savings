      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="card" style="background-color: rgba(0,128,128,0.2); box-shadow: 0 4px 8px 0	rgba(119,136,153, 0.8);height: 320px;max-width: 600px;margin: auto; text-align: center;font-family: arial;">
            <h2 style="text-align:center"> Expense Money</h2>
            <hr>

            <form name="income" action="addexpenses.php" method="post" name="showexp" id="myForm">
        ...
        if (charCode > 31 && (charCode != 46 &&(charCode < 48 || charCode > 57)))
            ...
            return true;
                   ...
                   <option >Category</option>
                    <option value="House Charge">House Charge</option>
                    <option value="Utility Cost">Utility Cost</option>
                    <option value="Mealing Cost">Mealing Cost</option>
...
if(isset($_POST["entrydate"]) && trim($_POST["entrydate"]) != "")
  {
    ...
    $sql = "INSERT INTO expense (username, date, category, amount )
