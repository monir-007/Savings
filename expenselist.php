...
<body data-spy="scroll" data-target="#navbar-example">
  ...
  <div id="about" class="about-area area-padding">
    <div class="container">
      ...
      <div class="panel panel-warning">
        <div class="panel-heading">
          <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Trace Your Expenses Record
        </div>
        <div class="panel-body">
        <div class="col-lg-8" style="background-color: rgba(0,128,128,0.2); width: 400px;margin-right:10px;">

                <form class="form-horizontal"  action="expenselist.php" method="post" name="showexp" >

                  <div class="form-group" style="margin-left:7px;">
                    <label class="input-group form_datetime"  >Category:</label>
                    <select class="input-group form_datetime" style="width:200px;" name="category" id="exdetail" autofocus>
                  ...
                  <div class="form-group" style="margin-left:7px;">
                    <div class="input-group form_datetime" >
                      <label class="input-group form_datetime" style="margin-top:7px;" >Start:</label>
                        <input class="form-control" size="60" style="width:250px;" type="text" value="<?php $dstart = date("01-m-Y"); echo $dstart; ?>" id="datepicker1" name="startd" readonly placeholder="Start Date" >
                    </div>
                  </div>
                  <div class="form-group" style="margin-left:7px;">
                      <div class="input-group date form_datetime" >
                        ...
                        <input class="form-control" size="60" style="width:250px;" type="text" name="endd" id="datepicker2" readonly value="<?php $thisday = strtotime($today);
    ...
    ?>
              ...
              <tr class="success"><th>Date</th> <th> Expense Description </th><th> Total Price</th><th><a href="expensedelete.php" class='btn btn-sm'>Edit</a></th></tr>
              ...
              if ($result->num_rows > 0)
                  ...
                  while($row = $result->fetch_assoc())
                  {
                    ...
                    $exdate = date('d M Y', $exdate);
                      echo "<tr><td> " . $exdate. "</td> <td> " . $row["category"]. " </td><td> " . $row["amount"]. "</td><td> <a href='expensedelete.php' id='del' class='btn btn-sm' name='remove' value='remove'><span class='glyphicon glyphicon-remove white' aria-hidden='true'></span></a></td></tr>";
                  }
              } else {
